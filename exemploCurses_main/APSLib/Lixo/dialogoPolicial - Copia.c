...
void Policial(gameData * game)
{
    ...
    switch(game->ultimaTecla){
        default:
            mvprintw(game->meioTela.y + 5, 0,"########## O policial James, um velho amigo de infancia abre a porta e lhe recebe. ##########");
            mvprintw(game->meioTela.y + 6, 0,"Policial James - Vamos entre, a chuva esta muito forte, afinal de contas, o que faz aqui?");
            mvprintw(game->meioTela.y + 7, 0,"               - Nao sabia que tambem era amigo do prefeito. ");
            mvprintw(game->meioTela.y + 8, 0,"-------------------------------------------------------------------------");
            mvprintw(game->meioTela.y + 9, 0," > 1 - Ola James.");
            mvprintw(game->meioTela.y + 10, 0," > 2 - Eu recebi uma ligacao falando sobre um assassinato.");
            mvprintw(game->meioTela.y + 11, 0," > 3 - EU?! O QUE VOCE FAZ AQUI?");
            break;
        case '1':// termina em Caso 3-4 (3-3) (1-1)
        {
            mvprintw(game->meioTela.y + 5, 0," >> Ola James.");
            mvprintw(game->meioTela.y + 6, 0,"Policial James - Ola de novo, mas me conta logo, o que voce faz aqui\n?");
            mvprintw(game->meioTela.y + 7, 0,"-------------------------------------------------------------------------");
            mvprintw(game->meioTela.y + 8, 0," > 1 - Ah, eu fui chamado para resolver algum assassinato ou algo assim. ");
            mvprintw(game->meioTela.y + 9, 0," > 2 - Eu recebi uma ligacao falando sobre um assassinato.");
            mvprintw(game->meioTela.y + 10, 0," > 3- Eu nao vou te falar nada seu otario.");
            break;
            int seg =0;
            scanf("%d",&seg);
